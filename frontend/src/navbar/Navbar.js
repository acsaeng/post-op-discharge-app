...
const Navbar = () => {
  return (
    <nav className="navbar navbar-expand-lg navbar-light justify-content-between mb-5" style={{backgroundColor: "#e9ecef"}}>
        <a className="navbar-brand mx-3 fs-3" style={{color: "#162a53"}} href="/"><FaUserCircle /></a>

        <form className="d-flex form-inline my-2 my-lg-0">
            <input className="form-control mr-sm-2 me-1" type="search" placeholder="Search"></input>
